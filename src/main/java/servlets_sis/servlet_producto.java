...
public class servlet_producto extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch(accion){
            ...
            case "mod":
                ...
                request.getRequestDispatcher("vistas/udp_producto.jsp").forward(request, response);
                break;
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        double precio_unitario = Double.parseDouble(request.getParameter("txtpreciounitario"));
